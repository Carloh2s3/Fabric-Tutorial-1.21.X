...
public class ModTags {
    public static class Blocks {
        ...
        public static final TagKey<Block> NEEDS_STEEL_TOOL = createTag("needs_pink_garnet_tool");
        ...
        private static TagKey<Block> createTag(String name) {
            return TagKey.of(RegistryKeys.BLOCK, Identifier.of(KaupenjoeTutorial.MOD_ID, name));
        }
    }
    public static class Items {
        ...
        private static TagKey<Item> createTag(String name) {
            return TagKey.of(RegistryKeys.ITEM, Identifier.of(KaupenjoeTutorial.MOD_ID, name));
        }
    }
}
