...
import com.cageeater.tutorialmod.item.ModArmorMaterials;
    ...
    private static final Map<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>>())
                    .put(ModArmorMaterials.PINK_GARNET_ARMOR_MATERIAL,
                            List.of(new StatusEffectInstance(StatusEffects.HASTE, 200, 1, false, false),
                    ...
                    .put(ModArmorMaterials.STEEL_ARMOR_MATERIAL,
                            List.of(new StatusEffectInstance(StatusEffects.RESISTANCE, 200, 0, false, false),
                                    new StatusEffectInstance(StatusEffects.SLOWNESS, 200, 0, false, false))).build();
